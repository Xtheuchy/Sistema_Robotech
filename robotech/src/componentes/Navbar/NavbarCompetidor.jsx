...
const NavbarCompetidor = ({ setCompetidorActivo }) => {
            ...
            <nav className={`navbar-gamer ${scrolled ? "scrolled" : ""}`}>
                <div className="navbar-container">
                    ...
                    <ul className={`navbar-menu ${mobileMenuOpen ? "active" : ""}`}>
                        <li>
                            <Link
                                to="/perfil/competidor"
                                className={`nav-link ${isActive("/perfil/competidor") ? "active" : ""}`}
...
export default NavbarCompetidor;
