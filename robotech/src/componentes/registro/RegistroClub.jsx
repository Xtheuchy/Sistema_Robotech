...
const RegistroClub = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess(`¡Registro exitoso! Tu código de club es: ${codigoClub}`);
            ...
            if (err.message.includes("ya está registrado") || err.message.includes("existe")) {
                setError("Este correo, DNI o nombre de club ya está registrado. Modifica los datos para registrarte.");
            } else {
            ...
            <div className="registro-container">
                ...
                <div className="registro-form-container">
                    ...
                    <div className="form-footer">
                        <p>
                            ¿Ya tienes cuenta?{" "}
                            <Link to="/login/club">Inicia sesión aquí</Link>
                        </p>
                    </div>
                </div>
            </div>
